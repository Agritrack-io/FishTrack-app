...
public class CaenLoggerReadTemperatureDialogFragment extends DialogFragment implements TimeAnimator.TimeListener{
    ...
    public CaenLoggerReadTemperatureDialogFragment() {
    ...
    public static CaenLoggerReadTemperatureDialogFragment newInstance(String epc) {
        CaenLoggerReadTemperatureDialogFragment frag = new CaenLoggerReadTemperatureDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_dialog_read_temperatures_caen_logger, container, false);
