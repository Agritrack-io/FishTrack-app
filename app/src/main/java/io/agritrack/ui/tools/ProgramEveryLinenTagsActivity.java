...
public class ProgramEveryLinenTagsActivity extends AppCompatActivity {
    ...
    private TextView tvProductCode, tvNotSameCnt, tvFilterEPC, tvProgOutcome;
    private Button btnLinenType, btnWriteEPC, btnSearch, btnScan;
    private SingleShotScanner scanner;
    private Long notSameCodeCount = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program_every_linen_tags);
        ...
        SoundUtil.initSoundPool(ProgramEveryLinenTagsActivity.this);

        notSameCodeCount = null;
        candidateTag = null;
        ...
        btnLinenType.setOnClickListener(view -> {
            linenTypeDialog = new SimpleListDialog(ProgramEveryLinenTagsActivity.this, Arrays.asList(schemeSvc.distinctNamesOnly()), currentTypeSelection, R.string.type_linen);
        ...
        ivSupport.setOnClickListener(view -> {
            supportDialog = new SupportDialog(ProgramEveryLinenTagsActivity.this);
    ...
    private void assignCtrlVars() {
        ...
        tvNotSameCnt = findViewById(R.id.tvNotSameCnt);
...
//            startActivity(i);
    ...
    protected void scanFalse() {
        ...
        scanner.setExcludedFilter(currentProductCode);
        scanner.LowEnergy();
    ...
    protected void onClick(View view) {
        if (Strings.isEmptyOrWhitespace(currentProductCode)) {
            CToast(getApplicationContext(), render("Παρακαλώ επιλέξτε πρώτα είδος!!"), Toast.LENGTH_LONG);
            return;
        }
    ...
    private class ScanHandler extends Handler {
        private final WeakReference<ProgramEveryLinenTagsActivity> mActivity;

        public ScanHandler(ProgramEveryLinenTagsActivity activity) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    notSameCodeCount = msg.getData().getLong("cnt");
                    tvNotSameCnt.setText(String.valueOf(notSameCodeCount));
                    String rssi = msg.getData().getString("rssi");
                    tvProgOutcome.setText("");
                    ivProgOutcome.setColorFilter(null);

                    if (notSameCodeCount > 0) {
                        tvNotSameCnt.setText(String.valueOf(notSameCodeCount));
                    } else {
                        tvNotSameCnt.setText(String.valueOf(notSameCodeCount));
                        CToast(getApplicationContext(), render("No false tags were found!!"), Toast.LENGTH_LONG);
                    }
