...
import io.agritrack.epctagcoder.option.PrefixLength;
import io.agritrack.epctagcoder.option.SGTIN.SGTINExtensionDigit;
import io.agritrack.epctagcoder.option.SGTIN.SGTINFilterValue;
import io.agritrack.epctagcoder.option.SGTIN.SGTINHeader;
import io.agritrack.epctagcoder.option.SGTIN.SGTINTagSize;
import io.agritrack.epctagcoder.option.SGTIN.partitionTable.SGTINPartitionTableList;
import io.agritrack.epctagcoder.option.TableItem;
import io.agritrack.epctagcoder.result.SGTIN;
import io.agritrack.epctagcoder.util.Converter;
