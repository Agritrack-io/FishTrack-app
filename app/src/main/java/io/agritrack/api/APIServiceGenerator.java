...
public class APIServiceGenerator {
    ...
    private static final String BASE_URL = "http://3.68.68.173:5000/"; //http://192.168.150.8:5000"; //"http://fishtrackbackend-env.eba-b2cqygnf.eu-central-1.elasticbeanstalk.com";
