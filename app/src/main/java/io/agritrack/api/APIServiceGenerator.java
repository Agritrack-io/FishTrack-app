...
public class APIServiceGenerator {
    ...
    private static final String BASE_URL = "http://192.168.1.5:5000";// "http://fishtrackbackend-env.eba-b2cqygnf.eu-central-1.elasticbeanstalk.com"; //"http://192.168.1.2:5000";
