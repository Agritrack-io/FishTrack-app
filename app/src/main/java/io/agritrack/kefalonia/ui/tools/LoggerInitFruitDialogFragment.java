...
import static io.agritrack.kefalonia.caen.api.CAEN_CONSTANTS.CmdINIT;
import static io.agritrack.kefalonia.caen.api.CAEN_CONSTANTS.CmdRESET;
import static io.agritrack.kefalonia.caen.api.CAEN_CONSTANTS.CmdReadData;
import static io.agritrack.kefalonia.caen.api.CAEN_CONSTANTS.CmdReadSamplesCnt;
import static io.agritrack.kefalonia.caen.api.CAEN_CONSTANTS.CmdSETUP;
import static io.agritrack.kefalonia.caen.api.CAEN_CONSTANTS.CmdSTOP;
...
//            mScanHandler.sendMessage(createMessage(WriteTimeStamp, resCurrTime));
    ...
    private State state = null;    final Runnable readCTRLThread = new Runnable() {
        @Override
        public void run() {
