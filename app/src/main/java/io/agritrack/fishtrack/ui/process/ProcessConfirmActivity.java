...
import static io.agritrack.fishtrack.state.GlobalState.recProcessing;
...
public class ProcessConfirmActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void configFooter() {
        ...
        ivNext.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(ProcessConfirmActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ProcessConfirmActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, ProcessConfirmActivity.this);
    ...
    public void onLocationChanged(@NonNull Location location) {
        recProcessing.longitude = location.getLongitude();
        recProcessing.latitude = location.getLatitude();
