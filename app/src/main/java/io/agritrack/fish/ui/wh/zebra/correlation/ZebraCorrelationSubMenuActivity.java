...
public class ZebraCorrelationSubMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zebra_correlation_sub_menu);
        ...
        progressDialog = new ProgressDialog(ZebraCorrelationSubMenuActivity.this);
        ...
        switch (finalPosition) {
            case 0:
                ...
                menuItemsList.add(new MenuItem(getString(R.string.menu_title_correlation), ZebraCorrelationCageActivity.class, R.drawable.cage));
                clazz = ZebraCorrelationCageActivity.class;
                break;
            case 1:
...
//                break;
        ...
        menuItemsList.add(new MenuItem(getString(R.string.menu_title_replace_tags), ZebraExistingTagActivity.class, R.drawable.program));
        menuItemsList.add(new MenuItem(getString(R.string.menu_title_new_tags), ZebraNewTagActivity.class, R.drawable.program));
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                switch (position) {
                    ...
                    case Existing_Tag_Idx:
                        i = new Intent(appCtx, ZebraExistingTagActivity.class);
                        break;
                    case New_Tag_Idx:
                        i = new Intent(appCtx, ZebraNewTagActivity.class);
                        break;
                    default:
                }
        ...
        ivSupport.setOnClickListener(view -> {
            supportDialog = new SupportDialog(ZebraCorrelationSubMenuActivity.this);
    ...
    protected void configFooter() {
        ...
        ivBack.setOnClickListener(view -> {
            Intent i = new Intent(getApplicationContext(), ZebraCorrelationMenuActivity.class);
            startActivity(i);
        });
    }
}