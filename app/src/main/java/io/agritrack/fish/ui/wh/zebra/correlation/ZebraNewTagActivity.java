...
public class ZebraNewTagActivity extends LocationAwareActivity {
    ...
    private final ZebraNewTagActivity.ScanHandler mScanHandler = new ZebraNewTagActivity.ScanHandler(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zebra_new_tag);
...
//        x9programmer = new BX6100Programmer();
        ...
        progressDialog = new ProgressDialog(ZebraNewTagActivity.this);
        ...
        ivSupport.setOnClickListener(view -> {
            supportDialog = new SupportDialog(ZebraNewTagActivity.this);
...
//            Boolean proceed = correlate();
            ...
            if (true) {
                ...
                Intent i = new Intent(getApplicationContext(), ZebraNewTagActivity.class);
                startActivity(i);
            }
        }
    }
    ...
    private class ScanHandler extends Handler {
        private final WeakReference<ZebraNewTagActivity> mActivity;

        public ScanHandler(ZebraNewTagActivity activity) {
