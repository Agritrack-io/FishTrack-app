...
public class CorrelationCageActivity extends LocationAwareActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(CorrelationCageActivity.this);
    ...
    private class ScanHandler extends Handler {
        private final WeakReference<CorrelationCageActivity> mActivity;

        public ScanHandler(CorrelationCageActivity activity) {
