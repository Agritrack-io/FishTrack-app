...
import io.agritrack.philosofish.caen.api.BX6100Programmer;
...
import io.agritrack.philosofish.dialog.CheckTagDialog;
...
public class ExistingTagActivity extends LocationAwareActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_existing_tag);
        ...
        progressDialog = new ProgressDialog(ExistingTagActivity.this);
    ...
    private void moveToNextScreen() {
        if (proceedWithoutLocation) {
            ...
            if (proceed) {
                ...
                Intent i = new Intent(getApplicationContext(), ExistingTagActivity.class);
                startActivity(i);
            }
        }
    }
    ...
    private boolean correlate() {
        ...
        try {
            ...
            syncTxAsyncCall.enqueue(new ExistingTagActivity.SyncTxCallBack());
    ...
    private class ScanHandler extends Handler {
        private final WeakReference<ExistingTagActivity> mActivity;

        public ScanHandler(ExistingTagActivity activity) {
