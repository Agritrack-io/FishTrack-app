...
public class CageListDialog {
    private final CageListAdapter itemsAdapter;
    private final Activity activity;
    private TextView tvTitle;
    private RecyclerView rvItems;
    private Dialog dialog;

    public CageListDialog(Activity activity, List<String> data, MutableLiveData<String> liveData, @StringRes int title) {
        ...
        itemsAdapter = new CageListAdapter(this.activity, data, false);
